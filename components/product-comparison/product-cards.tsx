    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {products.map((product) => (
                <div
                    key={product.id}
                    className={`border rounded-lg overflow-hidden flex flex-col h-full ${marketplace === "amazon" ? "bg-white dark:bg-gray-900" : "bg-white dark:bg-gray-900"
                        }`}
                >
                        ...
                        <div className="flex mb-4">
                            ...
                            <div>
                                ...
                                <div className="mb-1">
                                    ...
                                    {product.reviews && (
                                        <span className="text-xs text-muted-foreground">({product.reviews.toLocaleString()} reseñas)</span>
                                    )}
                                </div>
                                {product.price ? (
