      ...
      <CardContent className="p-0">
        <div className="flex justify-between items-center p-4 border-b">
          <div>
            ...
            <Badge variant="outline">{data.numberOfResults}</Badge>
          </div>
          ...
          <Table>
            ...
            <TableBody>
              {data.items?.map((item) => {
                ...
                const salesRank = item.salesRanks?.[0]?.ranks?.[0]
                ...
                return (
                  <TableRow key={item.asin}>
                    ...
                    <TableCell>
                      ...
                      <div className="text-xs text-muted-foreground">ASIN: {item.asin}</div>
                    </TableCell>
                    <TableCell>{summary?.brandName || "Unknown"}</TableCell>
